...
const DEFAULT_COMPANY_NAME = 'latitud';
const DEFAULT_PACKAGE_NAME = 'com.reactnativestarterkit';
const DEFAULT_PROJECT_NAME = 'ReactNativeStarterKit';
...
const readInput = (input) => new Promise((resolve, reject) => {
